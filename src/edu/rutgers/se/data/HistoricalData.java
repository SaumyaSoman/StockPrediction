...
public class HistoricalData {
	...
	public static void main(String[] args) {		
		...
		for (String symbol : symbols) {
			JSONObject jsonObject=hdata.collectData(symbol);
			if(jsonObject!=null){
				//save data
	...
	private JSONObject collectData(String symbol) {
		URL url;
		...
		try {
			...
			url = new URL("https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20yahoo.finance.historicaldata%20where%20symbol%20%3D%20%22"+symbol+"%22%20and%20startDate%20%3D%20%222014-04-28%22%20and%20endDate%20%3D%20%222015-05-01%22&format=json&env=http%3A%2F%2Fdatatables.org%2Falltables.env&callback=");
